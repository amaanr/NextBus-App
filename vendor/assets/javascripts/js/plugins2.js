...
(function (e) {
    ...
    e(document).mouseup(function () {
        ...
        _getItemsAsjQuery: function (t) {
            ...
            var r, i, s, o, u = [],
                a = [],
                f = this._connectWith();
            if (f && t) for (r = f.length - 1; r >= 0; r--) for (s = e(f[r]), i = s.length - 1; i >= 0; i--) o = e.data(s[i], this.widgetFullName), o && o !== this && !o.options.disabled && a.push([e.isFunction(o.options.items) ? o.options.items.call(o.element) : e(o.options.items, o.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), o]);
        ...
        _contactContainers: function (t) {
            ...
            if (h) if (1 === this.containers.length) this.containers[p].containerCache.over || (this.containers[p]._trigger("over", t, this._uiHash(this)), this.containers[p].containerCache.over = 1);
            else {
    ...
    e.extend(i.prototype, {
        ...
        parseDate: function (t, n, r) {
            ...
            for (i = 0; t.length > i; i++) if (b)"'" !== t.charAt(i) || w("'") ? x() : b = !1;
        ...
        formatDate: function (e, t, n) {
            ...
            var r, i = (n ? n.dayNamesShort : null) || this._defaults.dayNamesShort,
                ...
                c = "",
                h = !1;
            if (t) for (r = 0; e.length > r; r++) if (h)"'" !== e.charAt(r) || a("'") ? c += e.charAt(r) : h = !1;
    ...
    e.effects = {
        ...
        function t(t) {
            var n, r, i = t.ownerDocument.defaultView ? t.ownerDocument.defaultView.getComputedStyle(t, null) : t.currentStyle,
                s = {};
            if (i && i.length && i[0] && i[i[0]]) for (r = i.length; r--;) n = i[r], "string" == typeof i[n] && (s[e.camelCase(n)] = i[n]);
        ...
        getDataFromFeed: function (e, t) {
            ...
            if (!jQuery.browser.msie) {
                jQuery.getJSON(jQuery.mbYTPlayer.locationProtocol + "//gdata.youtube.com/feeds/api/videos/" + e + "?v=2&alt=jsonc", function (e, n, r) {
                    ...
                    t.title = i.title;
                    t.videoData = i;
                    if (t.opt.ratio == "auto") if (i.aspectRatio && i.aspectRatio === "widescreen") t.opt.ratio = "16/9";
...
(function (e) {
    ...
    e.event.special.mousewheel = {
        setup: function () {
            if (this.addEventListener) for (var e = n.length; e;) this.addEventListener(n[--e], t, false);
            else this.onmousewheel = t
        },
        teardown: function () {
            if (this.removeEventListener) for (var e = n.length; e;) this.removeEventListener(n[--e], t, false);
...
eval(function (e, t, n, r, i, s) {
    ...
    while (n--) if (r[n]) e = e.replace(new RegExp("\\b" + i(n) + "\\b", "g"), r[n]);
    return e
